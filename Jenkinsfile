								...
								dir('api') {
											...
											step([$class: 'XrayImportBuilder', endpointName: '/cucumber/multipart',importInfo:'''{
													...
													"fields": {
														...
														"summary": "Smoke Api Test Execution for BDD (Generated By ${BUILD_TAG})",
														"issuetype": {
															"id": "10007"
														},
												...
												}''',inputInfoSwitcher:"fileContent",importFilePath: '\\target\\surefire-reports\\com.virtusa.qa.api.product.json', serverInstance: 'ce436e2b-0499-443c-9431-1864e5d99242'])
								...
								dir('api') {
									...
									step([$class: 'XrayImportBuilder', endpointName: '/cucumber/multipart',importInfo:'''{
													...
													"fields": {
														...
														"summary": "Regression Api Test Execution for BDD (Generated By ${BUILD_TAG})",
														"issuetype": {
															"id": "10007"
														},
								...
								dir('swing') {
									...
									step([$class: 'XrayImportBuilder', endpointName: '/cucumber/multipart',importInfo:'''{
													...
													"fields": {
														...
														"summary": " Desktop App Test Execution for BDD (Generated By ${BUILD_TAG})",
														"issuetype": {
															"id": "10007"
														},
												...
												}''',inputInfoSwitcher:"fileContent",importFilePath: '\\target\\cucumber-reports\\Cucumber.json', serverInstance: 'ce436e2b-0499-443c-9431-1864e5d99242'])
