    ...
    stages {
        ...
        stage('Deploy') {
            steps {
                ...
                sh 'curl --upload-file target/addressbook.war "http://tomcat:password@34.93.238.186:8083/manager/text/deploy?path=/addressbook&update=true"'
